...
export class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.cameras.main.centerX, 32, "SCORE", {fontSize: '32px', align: 'center'}).
        setOrigin(0.5);
        ...
        this.add.text(this.cameras.main.centerX, this.cameras.main.height - 256, 'Press SPACE to play again', {fontSize: '16px', color: '#fff'}).setOrigin(0.5);
